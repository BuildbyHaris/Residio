...
import { verifyResetSession } from "../services/auth.service";
...
const ResetPassword = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen w-full bg-[#fdf6ee] flex items-center justify-center">
        <FiLoader className="animate-spin text-[#ec6a52]" size={40} />
      </div>
    );
  }
